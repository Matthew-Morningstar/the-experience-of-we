...
We each have edges. Places where we can go and places we cannot. Things we can hold and things that are too much.
...
- **Be specific.** The domain, the limit, and if it helps, the reason. "I can't do serious conversations after 10pm. My capacity is gone by then."
...
The full guide, *Sensing, Naming, and Negotiating Boundaries Together*, holds eleven practices for building a boundary culture: body-based boundary sensing, capacity inventory, clear boundary statements, receiving boundaries gracefully, negotiating when edges meet, remembering each other's recurring limits, boundary check-ins, communicating when boundaries change, repairing violations, and seeing boundaries as connection. It explores the three movements of boundary work (sensing, naming, negotiating) and how to work with different boundary styles.
