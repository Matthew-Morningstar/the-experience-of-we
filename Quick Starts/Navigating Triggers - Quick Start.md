...
- **Choose a signal together.** "I'm triggered." A hand on the chest. "Past is here." Something simple, something you can use even when activated.
...
- **Come back together when ready.** Not to finish the argument. To reconnect first. "Are you here with me again?" "What just happened?" Then, if needed, you can return to the conversation from a different place.
...
The full guide, *Navigating Triggers Together*, holds practices for building shared capacity: learning each other's trigger patterns, signaling activation, responding to a triggered partner, processing what got stirred up, and learning from trigger moments over time. It explores how triggers form, how they activate, and how two people can become allies rather than adversaries when the past arrives in the present.
