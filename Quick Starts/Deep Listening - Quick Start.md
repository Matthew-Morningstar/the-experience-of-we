...
### The three-minute receive

Set a timer. For three minutes, one person speaks freely about whatever is alive for them. The listener's only job is to receive.
...
The full guide, *Practicing Deep Listening Together*, holds seven practices for developing full receptive presence: emptying before listening, listening beneath words, resisting the urge to respond, giving presence rather than silence, and holding what we receive before answering. It explores what blocks deep listening, how to listen during conflict, and why genuine reception is one of the deepest gifts we can offer.
