...
The full guide, *Co-Metabolizing Together*, holds practices for developing shared metabolic capacity: creating conditions for co-processing, developing the ability to hold complexity as a dyad, working with emotional material that exceeds individual capacity, and recognizing when the relational field has become a processing system. It explores why this capacity is the hallmark of a mature relational system.
