...
The full guide, *Developing Shared Values Together*, holds nine practices for building a shared compass: discovering individual values, mapping where values meet and diverge, negotiating shared values, using values as a compass in decisions and conflict, having regular values conversations, navigating genuine value conflicts, living values under pressure, updating values as you grow, and weaving values into the fabric of daily life. It explores where values come from, the difference between assumed and developed values, why value conflicts are among the most important moments in a relationship, and how to work with power dynamics that make one person's values quietly dominate.
