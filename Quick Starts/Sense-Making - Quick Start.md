...
The full guide, *Sense-Making Together*, holds eight practices for developing this capacity: gathering signals, finding patterns, contextualizing within larger dynamics, articulating understanding, testing it against reality, making sense of the relationship itself, including what the body knows, and updating your understanding as things change. It explores the difference between sense-making and meaning-making, why we need each other for this, and how to work with the common breakdowns: going in circles, getting derailed, or being unable to agree on what's happening.
