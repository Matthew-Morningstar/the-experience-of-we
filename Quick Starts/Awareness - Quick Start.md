...
Between us, there is always something happening. A quality. A temperature.
...
The full guide, *Developing Awareness Together*, holds eight practices for building shared sensitivity to the relational field: sensing through the body, tracking transitions, developing background awareness, and sensing the field during difficulty. It explores what awareness requires, what blocks it, and how this capacity becomes the perceptual foundation for all the relational work that follows.
