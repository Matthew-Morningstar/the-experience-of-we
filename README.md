...
The practices in this repository are informed by a larger theoretical framework exploring consciousness, relational systems, co-regulation, metabolic aliveness, and the systemic conditions of the modern world. That framework includes work on:
...
This work is licensed under [Creative Commons Attribution-ShareAlike 4.0 International](LICENSE.md) (CC BY-SA 4.0).

You are free to share, adapt, and build upon this work, as long as you credit the source and share your contributions under the same terms.

---

*Homegrown in Chicago, in love and service to Momma Earth, Father Sun, and all their children.*
